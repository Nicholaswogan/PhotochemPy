...
gfortran -c ../../src/modules/Rainout_vars.f90 -O3 -fopenmp -freal-4-real-8
gfortran -c ../../src/modules/reading_vars.f90 -O3 -fopenmp -freal-4-real-8
gfortran -c ../../src/lin_alg.f -O3 -fopenmp -freal-4-real-8
gfortran -c ../../src/Photochem.f90 -O3 -fopenmp -freal-4-real-8

# compile the main program
gfortran -c PhotoMain.f90 -O3 -fopenmp -freal-4-real-8
