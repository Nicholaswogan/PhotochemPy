...
photochem.read_species('input/templates/Archean+haze/species.dat')
photochem.read_reactions('input/templates/Archean+haze/reactions.rx')
photochem.read_planet('input/templates/Archean+haze/planet.dat')
photochem.read_photochem('input/templates/Archean+haze/input_photchem.dat')
photochem.read_atmosphere('input/templates/Archean+haze/atmosphere.txt')
...
photochem.aertab()
photochem.initphoto('input/templates/Archean+haze/Sun_2.7Ga.txt')
