        ...
        do J=1,NR
          ...
          ! the below are rate constants which don't fit in the 2BODY or 3BODY category
            ...
            DO I=1,NZ
              ...
              !   CH23 + H -> CH3
              if (CHEMJ(1,J).EQ.'CH23'.AND.CHEMJ(2,J).EQ.'H'.AND.CHEMJ(3,J) &
                .EQ. 'CH3') THEN
              ...
              !  C2H2 + OH -> CH2CO + H
              if (CHEMJ(1,J).EQ.'C2H2'.AND.CHEMJ(2,J).EQ.'OH'.AND.CHEMJ(3,J) &
                .EQ. 'CH2CO') THEN
              ...
              ! added by nick
              !   H2CN + NH2  ->  HCN + NH3
              if (CHEMJ(1,J).EQ.'H2CN'.AND.CHEMJ(2,J).EQ.'NH2') THEN
                A(J,I) = 5.42E-11*(300/T(i))**1.06 * EXP(-60.8/T(i))
              endif

              !   H2CN + M  ->  HCN + H + M
              if (CHEMJ(1,J).EQ.'H2CN'.AND.CHEMJ(2,J).EQ.'M'.AND.CHEMJ(3,J) &
                .EQ.'HCN') THEN
                A(J,I) = 5.50E-17*DEN(I)
              endif

              !   HNCO + OH  ->  NCO + H2O
              if (CHEMJ(1,J).EQ.'HNCO'.AND.CHEMJ(2,J).EQ.'OH'.AND.CHEMJ(3,J) &
                .EQ.'NCO') THEN
              ...
              !   HNCO + H  ->  HNCO
              if (CHEMJ(1,J).EQ.'HNCO'.AND.CHEMJ(2,J).EQ.'H'.AND.CHEMJ(3,J) &
                .EQ.'HNCOH') THEN
              ...
              !   HNCO + O  ->  CO2 + NH
              if (CHEMJ(1,J).EQ.'HNCO'.AND.CHEMJ(2,J).EQ.'O'.AND.CHEMJ(3,J) &
                .EQ.'CO2') THEN
              ...
              !   NCO + O  ->  CN + O2
              if (CHEMJ(1,J).EQ.'NCO'.AND.CHEMJ(2,J).EQ.'O'.AND.CHEMJ(3,J) &
                .EQ.'CN') THEN
              ...
              !   NCO + H2  ->  HNCO + H
              if (CHEMJ(1,J).EQ.'NCO'.AND.CHEMJ(2,J).EQ.'H2'.AND.CHEMJ(3,J) &
                .EQ.'HNCO') THEN
                A(J,I) = 6.54E-14 * T(i)**2.58 * exp(-2700./T(i))
              endif

              !   NCO + OH  ->  HNCO + O
              if (CHEMJ(1,J).EQ.'NCO'.AND.CHEMJ(2,J).EQ.'OH'.AND.CHEMJ(3,J) &
                .EQ.'HNCO') THEN
                A(J,I) = 5.38E-14 * (T(i)/298)**2.27 * exp(-497./T(i))
              endif

              !   CN + C2H6  ->  HCN + C2H5
              if (CHEMJ(1,J).EQ.'CN'.AND.CHEMJ(2,J).EQ.'C2H6'.AND.CHEMJ(3,J) &
                .EQ.'HCN') THEN
                A(J,I) = 2.08E-11 * (T(i)/298.)**0.22 * exp(57.8/T(i))
              endif

              !   CN + CH4  ->  HCN + CH3
              if (CHEMJ(1,J).EQ.'CN'.AND.CHEMJ(2,J).EQ.'CH4'.AND.CHEMJ(3,J) &
                .EQ.'HCN') THEN
                A(J,I) = 5.11E-13 * (T(i)/298)**2.64 * exp(150./T(i))
              endif

              !   NO + C  ->  CO + N
              if (CHEMJ(1,J).EQ.'NO'.AND.CHEMJ(2,J).EQ.'C'.AND.CHEMJ(3,J) &
                .EQ.'CO') THEN
