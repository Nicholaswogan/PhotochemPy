...
! C-AP **********************************************************
      RSTAND = (/0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.007, &
        0.008, 0.009, 0.01, 0.03, 0.05, 0.07, 0.1, 0.13, 0.15, &
        0.17, 0.2, 0.23, 0.25,0.27, 0.3, 0.33,0.35, 0.37, &
        .4, 0.43,0.45, 0.47,0.5,0.53, 0.55,0.57,0.6,0.63,0.65, &
        0.67,0.7,0.730,0.750,0.770,0.8,0.83,0.85,0.87,0.9,0.93,0.95, &
        0.97,1.,2./)
