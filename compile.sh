...
# compile main module
f2py -c Photochem.f90 lin_alg.f Rainout_vars.o reading_vars.o -m Photochem only: allocate_memory right_hand_side \
jacobian read_species read_reactions read_atmosphere photgrid rates gridw readflux \
initphoto initmie read_planet read_photochem rainout ltning aertab
